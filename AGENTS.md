...
This project is indexed by GitNexus as **portfolio** (28 symbols, 19 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
